...
import 'package:laundry_application/core/constants/colors.dart';
import 'package:laundry_application/core/theme/app_theme.dart';
import 'package:laundry_application/core/utils/currency_formatter.dart';
import 'package:laundry_application/core/utils/thousand_separator_formatter.dart';
import 'package:laundry_application/data/models/customer.dart';
import 'package:laundry_application/data/models/order_item.dart';
import 'package:laundry_application/data/models/payment.dart';
import 'package:laundry_application/data/models/service.dart';
...
import 'package:laundry_application/logic/cubits/customer/customer_state.dart';
import 'package:laundry_application/logic/cubits/order/order_cubit.dart';
import 'package:laundry_application/logic/cubits/order/order_state.dart';
import 'package:laundry_application/logic/cubits/service/service_cubit.dart';
import 'package:laundry_application/logic/cubits/service/service_state.dart';
...
class _OrderFormScreenState extends State<OrderFormScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<OrderCubit, OrderState>(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Order Baru')),
        body: Form(
          key: _formKey,
          child: ListView(
            padding: const EdgeInsets.all(16),
