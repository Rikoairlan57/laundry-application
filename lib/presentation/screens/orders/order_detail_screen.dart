...
import 'package:laundry_application/logic/cubits/printer/printer_state.dart';
import 'package:laundry_application/core/services/whatsapp_service.dart';
                ...
                child: Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      context.read<OrderCubit>().updateStatus(
                        order.id!,
                        status,
                      );
                    },
